    ...
    while True:
        try:
            ...
            if value > 0:
                ...
                print("Не верный ввод. Введите положительное целое число.")
        except ValueError:
            print("Не верный ввод. Введите целое число.")
...
def main():
    ...
    while True:  # Бесконечный цикл для меню
        ...
        if choice == "0":
            ...
            order = int(input("Выберите порядок сортировки (1 - возрастание, 2 - убывание): "))  # Ввод порядка сортировки
            ...
            item = int(input("Введите элемент для поиска: "))  # Ввод искомого элемента
            ...
            NBegin = int(input("Введите начальное значение N: "))
            NEnd = int(input("Введите конечное значение N: "))
            NStep = int(input("Введите шаг для N: "))
